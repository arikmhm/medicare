...
<html>
<head>
    <title>MediCare - Manajemen Dokter</title>
    <meta charset="utf-8">
...
<body>
    ...
    <nav class="navbar navbar-expand navbar-light shadow-sm py-3">
        <div class="container-fluid">
            <h1 class="h3 mb-0">Manajemen Dokter</h1>
        ...
        <div class="page-header">
            <div class="d-flex align-items-center gap-4">
                <div class="search-container">
                    ...
                    <input type="text" id="search" class="search-input" placeholder="Cari dokter..." autofocus>
                </div>
        ...
        $(document).ready(function () {
            ...
            function loadData(page = 1, query = "") {
                $.ajax({
                    ...
                    error: function () {
                        showFeedback("error", "Gagal memuat data dokter.");
                    },
                });
            }
