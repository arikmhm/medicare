...
<html>
<head>
    <title>MediCare - Edit Dokter</title>
    <meta charset="utf-8">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kode_dokter" value="<?php echo htmlspecialchars($row['kode_dokter']); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="spesialisasi" required>
                                <?php
                                $spesialisasi = ['Umum', 'Anak', 'Penyakit Dalam', 'Bedah', 'Saraf', 'Mata', 'THT', 'Gigi'];
                                foreach ($spesialisasi as $sp) {
                                    $selected = ($sp === $row['spesialisasi']) ? 'selected' : '';
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_str" required value="<?php echo htmlspecialchars($row['no_str']); ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" name="no_telepon" required value="<?php echo htmlspecialchars($row['no_telepon']); ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
